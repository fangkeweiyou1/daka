...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mDatas.add(DakaModel(R.drawable.meinv1, "2019-06-01"))
        mDatas.add(DakaModel(R.drawable.meinv2, "2019-06-02"))
        mDatas.add(DakaModel(R.drawable.meinv3, "2019-06-03"))
        mDatas.add(DakaModel(R.drawable.meinv4, "2019-06-04"))
        mDatas.add(DakaModel(R.drawable.meinv5, "2019-06-05"))
        mDatas.add(DakaModel(R.drawable.meinv6, "2019-06-06"))
        mDatas.add(DakaModel(R.drawable.meinv7, "2019-06-07"))
        mDatas.add(DakaModel(R.drawable.meinv8, "2019-06-08"))
        mDatas.add(DakaModel(R.drawable.meinv9, "2019-06-09"))
        mDatas.add(DakaModel(R.drawable.meinv10, "2019-06-10"))
        mDatas.add(DakaModel(R.drawable.meinv11, "2019-06-11"))
        mDatas.add(DakaModel(R.drawable.meinv12, "2019-06-12"))
        mDatas.add(DakaModel(R.drawable.meinv13, "2019-06-13"))
        mDatas.add(DakaModel(R.drawable.meinv14, "2019-06-14"))
        mDatas.add(DakaModel(R.drawable.meinv15, "2019-06-15"))
        mDatas.add(DakaModel(R.drawable.meinv1, "2019-06-16"))
        mDatas.add(DakaModel(R.drawable.meinv2, "2019-06-17"))
        mDatas.add(DakaModel(R.drawable.meinv3, "2019-06-18"))
        mDatas.add(DakaModel(R.drawable.meinv4, "2019-06-19"))
        mDatas.add(DakaModel(R.drawable.meinv5, "2019-06-20"))
        mDatas.add(DakaModel(R.drawable.meinv6, "2019-06-21"))
        mDatas.add(DakaModel(R.drawable.meinv7, "2019-06-22"))
        mDatas.add(DakaModel(R.drawable.meinv8, "2019-06-23"))
        mDatas.add(DakaModel(R.drawable.meinv9, "2019-06-24"))
        mDatas.add(DakaModel(R.drawable.meinv10, "2019-06-25"))
        mDatas.add(DakaModel(R.drawable.meinv11, "2019-06-26"))
        mDatas.add(DakaModel(R.drawable.meinv12, "2019-06-27"))
        mDatas.add(DakaModel(R.drawable.meinv13, "2019-06-28"))
